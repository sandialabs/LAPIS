...
def main():
    ...
    module_kokkos = backend.reverse_diff_compile(moduleText, 'myfunc', 'grad_myfunc', ['active'], ['active', 'active', 'active'])
    eps = 1e-4
    ...
    dfdx, dfdy, dfdz = module_kokkos.grad_myfunc(x, y, z, 1.0)
